...
from prepare_vision import NUM_CLASSES, TIME_BUDGET, make_dataloader, evaluate_accuracy
...
from prepare_vision import create_cached_dataset, make_dataloader, get_num_classes
...
if val_images is None or val_labels is None:
    from prepare_vision import create_val_dataset, make_val_dataloader
