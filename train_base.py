"""
ConvNeXt-Base - smaller model, might generalize better with proper tuning.

Configuration:
- Batch size: 16 (larger due to smaller model)
- Optimizer: AdamW with LR=0.0001, weight_decay=0.03
- Time budget: 3600 seconds (60 minutes)

Usage: CUDA_VISIBLE_DEVICES=4 uv run train_base.py
"""
import os
