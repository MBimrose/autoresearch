"""
ViT-L/16 - Vision Transformer Large for image classification.
...
Usage: CUDA_VISIBLE_DEVICES=6 uv run train_vit.py
"""
import os
...
def main():
    ...
    # ViT-L/16 model with pretrained weights
    print("Loading ViT-L/16...")
    weights = ViT_L_16_Weights.IMAGENET1K_V1
    model = vit_l_16(weights=weights)

    # Replace classifier - ViT has a heads layer
