"""
ConvNeXt-Large with RMSprop optimizer.

Key insight: RMSprop can work well for fine-tuning CNNs.

Configuration:
- Batch size: 8
- Optimizer: RMSprop with LR=0.001, momentum=0.9
- Time budget: 3600 seconds (60 minutes)

Usage: CUDA_VISIBLE_DEVICES=7 uv run train_rmsprop.py
"""
import os
